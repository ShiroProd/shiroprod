...
/** A profile card hanging on a rope with pendulum physics — draggable, swings back to rest. */
export default function HangingProfileWidget() {
  ...
  return (
    <div ref={containerRef} className="relative w-[300px] h-[350px] flex justify-center -mt-4">
      ...
      <div
        ...
        className="absolute top-0 flex flex-col items-center justify-center p-4 w-[140px] rounded-2xl bg-surface/60 backdrop-blur-md border border-foreground/10 cursor-grab shadow-2xl select-none group hover:bg-surface/90 transition-colors duration-300"
        style={{
          left: "50%",
          marginLeft: "-70px",
      ...
      >
        <div className="w-20 h-20 rounded-full overflow-hidden border border-foreground/20 mb-3 bg-foreground/5 flex items-center justify-center pointer-events-none group-hover:border-accent/40 transition-colors duration-300">
          <Camera className="w-9 h-9 text-foreground/40 group-hover:text-accent transition-colors duration-300" />
        </div>
