        ...
        >
          ...
          >
            <div className="relative flex items-center justify-center w-36 h-36">
              ...
              <div className="absolute inset-3 rounded-full border border-border/50 bg-surface/50 backdrop-blur-md" />

              <span className="relative z-10 font-display text-sm tracking-[0.2em] text-foreground">
                SP
              </span>
            </div>

            <span className="font-display text-xs tracking-[0.35em] text-muted uppercase">
              Shiro Prod
            </span>
          </motion.div>
        </motion.div>
